...
No último artigo publicado, foi falado acerca do [**Modelo MVC**](/blog/mvc-uma-breve-explicacao/) e sobre aquilo em que este consiste. O Modelo _Model-View-Controller_ é amplamente utilizado nos dias de hoje.
...
{{< figure src="mvcuecphppI.jpg" alt="Modelo MVC - Uma exemplificação com PHP #1" >}}
